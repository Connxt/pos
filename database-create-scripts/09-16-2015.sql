...
-- Dumping database structure for philtruck_inventory
CREATE DATABASE IF NOT EXISTS `philtruck_inventory` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `philtruck_inventory`;
...
-- Dumping data for table philtruck_inventory.customers: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.deliveries: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.delivery_items: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.items: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.modes_of_payment: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.payments: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.receipts: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.receipt_items: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.suppliers: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.types_of_payment: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.users: ~0 rows (approximately)
...
-- Dumping data for table philtruck_inventory.user_levels: ~0 rows (approximately)
